...
describe('Block Component', () => {
    ...
    beforeEach(() => {
        ...
        (useLayoutStore as any).mockImplementation((selector: any) => {
            const state = {
    ...
    it('renders block title and machine info', () => {
        const recipe = DSP_DATA.recipes.find(r => r.id === mockBlockData.recipeId);
        console.log('Test Diagnostic - Recipe found:', recipe?.name);
        console.log('Test Diagnostic - Block Name:', mockBlockData.name);
