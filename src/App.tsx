...
import { Hammer, BarChart3, Play, RefreshCw, Target } from "lucide-react";
...
export function App() {
    ...
    const { leftSidebarOpen, toggleLeftSidebar, rightSidebarOpen, toggleRightSidebar, focusedNodeId, toggleFocus, autoSolveEnabled, toggleAutoSolve } = useUIStore();
    ...
    return (
        <div className="app-container">
            <header className="app-header">
                <div className="logo">DSP Planner <span className="version">v0.1.0</span></div>
                ...
                <nav className="app-nav">
                    ...
                    <button className="toolbar-btn" onClick={runSolver} title="Run Solver">
                    ...
                    <button
                        ...
                        title={autoSolveEnabled ? "Auto-Pilot: Solver writes values" : "Advisory: Manual control"}
                    >
                        <Play size={16} /> <span>{autoSolveEnabled ? 'Auto' : 'Manual'}</span>
                    </button>
