...
const RecipeCategoryEnum = z.enum(['smelting', 'assembling', 'refining', 'chemical', 'research', 'mining', 'other']);
...
const MachineSchema = z.object({
    ...
    icon: z.string().optional(),
    isCustom: z.boolean().optional(),
    allowedCategories: z.array(RecipeCategoryEnum).optional(),
});
...
const GameDefinitionSchema = z.object({
    id: z.union([z.enum(['dsp', 'factorio', 'satisfactory']), z.string()]),
    name: z.string(),
    version: z.string(),
    ...
    settings: z.object({
        ...
        gridSize: z.number(),
        defaultMachineIds: z.record(RecipeCategoryEnum, z.string().optional()).optional(),
    }),
});
