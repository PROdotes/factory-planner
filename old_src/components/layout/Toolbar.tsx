        ...
        <div className={`h-14 bg-surface/80 backdrop-blur-md border-b border-white/5 flex items-center px-6 justify-between select-none ${className}`}>
            <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center gap-1.5">
                    ...
                    <button
                        onClick={() => toggleViewSetting('showDebugBounds' as any)}
                        className={`glass-button !p-2 ${((viewSettings as any).showDebugBounds ? 'text-rose-400 bg-rose-400/10 border-rose-400/30' : 'text-white/40')}`}
                        title="Show Debug Bounds"
                    >
                        <Activity size={16} />
                    </button>
                </div>
